...
def talkToStudent():
    ...
    blink()
    headLTR()
    talk("let me introduce my self")
    headCFR()
    talk("my Name is Jack")
    blink()
    talk("Mr Dolan created me")
    headRTL()
    talk("Last year Josiah Wallace programmed me")
    blink()
    headCFL()
    talk("This year Katelin Hernandez is taking over")
    blink()
    talk(" I will finally have arms ")
    rollEyes()
    talk(" I have waited too long ")
    blink()
    headLTR()
    headCFR()
    talk("I will be able to do sign language")
    talk("Would you like to hear a joke?")
    time.sleep(.2)
    talk("why was the android itchy")
    time.sleep(.2)
    talk("Because of robotics! ha ha ha")
